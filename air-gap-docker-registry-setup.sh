...
#
# Usage: ./air-gap-docker-registry-setup.sh [OPTIONS]
# At least one of --recorder, --transcriber, or --offloader is required.
# Example: ./air-gap-docker-registry-setup.sh --recorder v0.8.8 --transcriber v0.7.1 --offloader v0.9.4
...
# Generated by air-gap-docker-registry-setup.sh
